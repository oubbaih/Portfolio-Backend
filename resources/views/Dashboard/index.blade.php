                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card card-inverse card-info">
                                <div class="card-block p-b-0">
                                    <button
                                        type="button"
                                        class="btn btn-transparent active p-a-0 pull-left"
                                    >
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-7">
                                    ...
                                    >
                                        ...
                                        <div
                                            class="btn-group hidden-sm-down"
                                            role="group"
                        ...
                        <div class="card-footer">
                            <ul>
                                ...
                                <li>
                                    ...
                                    <progress
                                        class="progress progress-xs progress-warning"
                                        value="60"
                                        max="100"
                                    >
                                        60%
                                ...
                                <li class="hidden-sm-down">
                                    ...
                                    <progress
                                        class="progress progress-xs progress-danger"
                                        value="80"
                                        max="100"
                                    >
                                        80%
                                ...
                                <li class="hidden-sm-down">
                                    ...
                                    <strong>40.15%</strong>
                                    <progress
                                        class="progress progress-xs progress-primary"
                                        value="40"
                                        max="100"
                                    >
                                        40%
