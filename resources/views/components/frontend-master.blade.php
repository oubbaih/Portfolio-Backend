...
<head>
    ...
    <link rel="icon" type="image/gif/png/svg" href="@if($setting->favicon){{Storage::disk('s3')->url($setting->favicon)}} :/" />
    ...
    <nav class="navbar fixed-top" id="navbar-id">
        <div class="container">
            <a class="navbar-brand logo" href="/">
                <img src="@if($setting->favicon){{Storage::disk('s3')->url($setting->favicon)}}:/" alt="favicon" />
                ...
                <div class="container">
                    <div class="offcanvas-header">
                        <a class="offcanvas-title menulogo" id="offcanvasNavbarLabel" href="/">
                            <img src="@if($setting->favicon){{Storage::disk('s3')->url($setting->favicon)}} : /" alt="favicon" />
                            <img src="@if($setting->logo){{Storage::disk('s3')->url($setting->logo)}} : /" alt="logo" />
                        </a>
